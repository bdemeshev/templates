...
rooster = import("metrics_rooster_kr_1.csv")
glimpse(rooster)
...
good_names = import("hse_metrics_2020_2021 - studs.csv")
glimpse(good_names)
good_names = select(good_names, canvas_ID, first_name, last_name)
...
filenames = list.files("output_1/181/", full.names = TRUE)
cnvs_comment_creator(filenames, rooster)

pdf_unifier(filenames, cnvs_comment_creator(filenames, rooster))

cnvs_sortirator("metrics_1", "output_1", rooster$ID, rooster$Section, rooster$fi)
cnvs_sortirator("metrics_2", "output_2", rooster$ID, rooster$Section, rooster$fi)
cnvs_sortirator("metrics_3", "output_3", rooster$ID, rooster$Section, rooster$fi)
